Criei uma aplicação REST simples que recebe um objeto json [MigrationRequest.java](src%2Fmain%2Fjava%2Fcom%2Fjala%2Flab8%2Fentities%2FMigrationRequest.java)
contendo
```json
